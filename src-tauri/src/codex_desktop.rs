...
"#,
    ...
    fn compatibility_script_summarizes_before_starting_a_fresh_session() {
        ...
        assert!(!script.contains(r#"["historyMode", "history mode"]"#));
        assert!(!script.contains(r#"["environments", "environment roots"]"#));
        assert!(!script.contains("startParams.projectId"));
        assert!(!script.contains("startParams.historyMode"));
        assert!(!script.contains("startParams.environments"));

...
"#,
    ...
    fn test_reasoning_content_mode_resolution() {
        ...
        assert_eq!(resolve_reasoning_content_mode(&deepseek), ReasoningContentMode::InjectContent);
        ...
        assert_eq!(resolve_reasoning_content_mode(&sublyx), ReasoningContentMode::Passthrough);
        ...
        assert_eq!(resolve_reasoning_content_mode(&forced_passthrough), ReasoningContentMode::Passthrough);
        ...
        assert_eq!(resolve_reasoning_content_mode(&custom_inject), ReasoningContentMode::InjectContent);
    }

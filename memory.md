...
- `#10` 的 portable 前提指 CCSwitchMulti 自身的 portable 版本，不是 Codex Desktop portable。Codex Desktop 仍按官方 Windows App / MSIX 安装边界处理；前端不要提供“手动选择 Codex.exe”主流程，也不要把路径写进 `ccswitch.codexDesktopExecutablePath`。

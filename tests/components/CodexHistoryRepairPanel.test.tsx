...
function repairOutcomeFixture(dryRun: boolean) {
  return {
    ...
    sqliteThreads: 7,
    rolloutThreadsDiscovered: 9,
    threadRowsToInsert: dryRun ? 2 : 0,
    ...
    sessionIndexDuplicateRowsToRemove: 3,
    sessionIndexDuplicateRowsRemoved: dryRun ? 0 : 3,
    projectRows: 7,

...
# CC Switch MultiRouter

### The All-in-One Manager for Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, OpenClaw & Hermes Agent

[![Version](https://img.shields.io/badge/version-3.19.2--17-blue)](https://github.com/tngflx/ccswitchmultirouter/releases)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey.svg)](https://github.com/tngflx/ccswitchmultirouter)
...
> - **Codex traffic policy** — admission control + rejection retry per provider
> - **Grouped API keys** (`CodexApiKeyGroup`) for different model tiers
> - **Per-provider reasoning content mode** with strict schema normalization
> - **Full i18n** — en/zh/zh-TW/ja with English as default for fresh installs
> - **Stream retry** — transparent proxy-side SSE reconnect before semantic output
> - **Language switcher** in the header for instant locale changes
...
- **Deep protocol probe** — Backend-driven Responses/Chat verification with per-model stage events and progress dialog
- **Traffic policy** — Per-provider admission control (max in-flight, queue wait) and rejection retry (429/503 replay)
- **Grouped API keys** — Separate API keys for different model tiers (`CodexApiKeyGroup`)
...
Star history for the original cc-switch project:

[![Star History Chart](https://api.star-history.com/svg?repos=farion1231/cc-switch&type=Date)](https://www.star-history.com/#farion1231/cc-switch&Date)

## License

MIT — see [LICENSE](LICENSE) for full text and copyright chain.

Original work Copyright (c) 2025 Jason Young (farion1231).
ccswitchmulti additions Copyright (c) 2025 BigStrongSun.
CC Switch MultiRouter modifications Copyright (c) 2025 Felix (tngflx).

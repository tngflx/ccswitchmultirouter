...
[![Version](https://img.shields.io/badge/version-3.19.2--17-blue)](https://github.com/tngflx/ccswitchmultirouter)
...
> **Fork of [ccswitchmulti](https://github.com/BigStrongSun/ccswitchmulti)** (itself a fork of [cc-switch](https://github.com/farion1231/cc-switch)) with additional fixes:
> - Sublyx strict Responses schema compatibility (fixes `content array too long` HTTP 400)
> - Header language switcher with English default for fresh installs
> - Cherry-picked upstream bug fixes (Kimi thinking injection removal, WSL atomic write fallback, and more)
